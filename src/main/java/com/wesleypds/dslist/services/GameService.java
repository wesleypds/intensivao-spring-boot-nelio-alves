...
public class GameService {
    ...
    @Transactional(readOnly = true)
    public List<GameMinProjectionDTO> searchGamesByGameList(Long listId) {
        return repository.searchGamesByGameList(listId).stream().map(g -> new GameMinProjectionDTO(g)).toList();
    }
